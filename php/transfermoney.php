...
<body>
    ...
    include './navbar.php';
    ?>
    <div class="center mt-0 #ffab00 accent-3" style="background-image: linear-gradient(45deg, lightblue, transparent);">
        <h3 style="height:60px;width:50px; margin-left:650px"><b> Transaction</b></h3>
    </div>
    <div class="container">
        <br />
        <div class="row">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="center"><a href="userdetails.php?c_id=<?php echo $rows['c_id']; ?>"> <button type="button" class="btn ">Transfer<i class="material-icons right">attach_money</i></button></a></td>
                                    </tr>
                            <?php
                                }
                            }
